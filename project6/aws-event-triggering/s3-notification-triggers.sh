...
email_address="vaibhavgosavi@gmail.com"
...
#Remove anhy carriage returns
role_arn=$(echo "$role_arn" | tr -d '\r') 
...
aws sns publish \
  ...
  --message "Hello from Vaibhav Gosavi. You Sucessfully created a s3 bucket"\
